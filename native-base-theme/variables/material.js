...
export default {
  ...
  segmentActiveBackgroundColor: '#2576BB',
  segmentTextColor: '#2576BB',
  segmentActiveTextColor: '#fff',
  segmentBorderColor: '#2576BB',
  segmentBorderColorMain: '#FAFAFA',
