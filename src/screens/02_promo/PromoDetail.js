						...
						<Content>
							<View style={{ flexDirection: 'column', justifyContent: 'center' }}>
								...
								<View style={{ flexDirection: 'row' }}>
									...
									>
										<Image source={images.icon_wallet} style={[ styles.sizeIcon ]} />
								...
								<View style={{ flexDirection: 'row' }}>
									...
									>
										<Image source={images.icon_discount} style={[ styles.sizeIcon ]} />
									...
									>
										<Image source={images.icon_money} style={[ styles.sizeIcon ]} />
								...
								>
									<View style={{ flexDirection: 'row', alignItems: 'center' }}>
										<Image source={images.icon_coupon} style={styles.sizeIcon} />
										<Text style={[ styles.Reg_18, { marginLeft: 10 } ]}>Kode Promo</Text>
									</View>
									<View style={{ flexDirection: 'row' }}>
										<View
											style={[
