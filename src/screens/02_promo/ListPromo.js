...
class ListPromo extends Component {
	constructor(props) {
		...
		this.state = {
			...
			promo: [
				{ title: 'Special Offer', des: 'Voucher 1 Night 1 Stay', image: images.images_promo1 },
				{ title: 'Special Offer SuMo', des: 'Hanya Rp 120.000/malam', image: images.images_promo2 },
				{ title: 'Grand Opening', des: 'Hanya Rp 99.000/malam', image: images.images_promo3 },
				{ title: 'Special Offer', des: 'Voucher 1 Night 1 Stay', image: images.images_promo1 },
				{ title: 'Special Offer SuMo', des: 'Hanya Rp 120.000/malam', image: images.images_promo2 },
				{ title: 'Grand Opening', des: 'Hanya Rp 99.000/malam', image: images.images_promo3 }
			],
