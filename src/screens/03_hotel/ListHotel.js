...
class ListHotel extends Component {
	constructor(props) {
		...
		this.state = {
			titlePage: 'Hotel',
			promo: [
				{ title: 'Tab Capsule Hotel Kayoon', des: 'Surabaya, Jawa Timur', image: images.images_promo1 },
				{ title: 'Tab Capsule Hotel Kayoon', des: 'Surabaya, Jawa Timur', image: images.images_promo2 },
				{ title: 'Tab Capsule Hotel Kayoon', des: 'Surabaya, Jawa Timur', image: images.images_promo3 },
				{ title: 'Tab Capsule Hotel Kayoon', des: 'Surabaya, Jawa Timur', image: images.images_promo1 },
				{ title: 'Tab Capsule Hotel Kayoon', des: 'Surabaya, Jawa Timur', image: images.images_promo2 },
				{ title: 'Tab Capsule Hotel Kayoon', des: 'Surabaya, Jawa Timur', image: images.images_promo3 },
				{ title: 'Tab Capsule Hotel Kayoon', des: 'Surabaya, Jawa Timur', image: images.images_promo1 },
			...
			listPromo.push(
				...
				>
					<View style={{ width: width - 140 }}>
						<Text style={[ styles.Bold_18, { color: colors.darkGrey } ]}>{data.title}</Text>
						<Text style={[ styles.Reg_14, { color: colors.darkGrey } ]}>{data.des}</Text>
					</View>
				</TouchableOpacity>
			);
		});
	...
	renderSearch() {
		return (
			<View style={[ styles.headerContainer, { marginTop: 20, marginLeft: 20, marginRight: 20 } ]}>
				<Input
				...
				<View style={{ flexDirection: 'row' }}>
					...
					>
						<Image source={images.icon_search} style={{ height: 20, width: 20, marginRight: 10 }} />
					</TouchableOpacity>
				</View>
			</View>
		);
